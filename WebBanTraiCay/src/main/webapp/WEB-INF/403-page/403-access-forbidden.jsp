...
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  ...
  <g>
    ...
    <g>
        ...
        <text opacity="0.6" x="15" y="257" fill="#000" font-family="Viga" font-size="25">${message1}
            <tspan x="35" y="292" >${message2}</tspan>
            <tspan x="100" y="357" fill="#000" font-size="65">403</tspan>
            <tspan x="93" y="381.2" fill="#000" font-size="15">${status}</tspan>
        </text>

        <text x="15" y="255" fill="#6BA184" font-family="Viga" font-size="25">${message1}
            <tspan x="35" y="290" >${message2}</tspan>
            <tspan x="100" y="355" fill="#BF3E73" font-size="65">403</tspan>
            <tspan x="93" y="380" fill="#6BA184" font-size="15">${status}</tspan>
        </text>
    </g>
    </g>
    </g>
