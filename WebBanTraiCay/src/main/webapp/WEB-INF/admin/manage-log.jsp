    ...
    <section class="home-section">
        ...
        <div class="content-container">
            ...
            <div class="main-content">
                <table id="table-log" class="display">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Địa chỉ ip</th>
...
<script>
    $(document).ready(function () {
        // Khởi tạo DataTables một lần
        // $('#table-log').DataTable({
        //     ajax: "http://localhost:8080/admin/user/SendJsonDataForFrontEnd",
        //     columns: [
        //         { data: "id" },
        //         { data: "username" },
        //         { data: "img" },
        ...
        //         idUser.push(rowData.id);
        //     });
        //
        //     $.ajax({
        //         type: "POST",
        //         url:"/admin/user/Delete1OrMoreUser",
        //         data: {
        //             mangIdUser: JSON.stringify(idUser)
        //         },
        //         success: function (response) {
        //             console.log("thành cng");
